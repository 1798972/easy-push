...
| 序号 | 渠道             | 实体类               | 测试类                                                | 说明文档                                                   | 官方链接                                              |
| ---- | ---------------- | -------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------------------- |
| 1    | 钉钉**群**文本消息 | [DingTextMessage](easy-push-model/src/main/java/cn/yang37/entity/message/impl/DingTextMessage.java) | [DingTextTest](easy-push-test/src/test/java/cn/yang37/easypush/test/DingTextTest.java) | [钉钉群文本消息.md](docs/渠道/钉钉/钉钉群文本消息.md) | [钉钉群文本消息](https://open.dingtalk.com/document/orgapp/custom-bot-to-send-group-chat-messages) |
| 2    | 腾讯云短信（V3） | [SmsTencentV3Message](easy-push-model/src/main/java/cn/yang37/entity/message/impl/SmsTencentV3Message.java) | [MainTest.sendTencentSmsV3Message](easy-push-test/src/test/java/MainTest.java) | - | [腾讯云短信](https://cloud.tencent.com/document/product/382/55981) |
| 3    | 阿里云短信（V3） | [SmsAliV3Message](easy-push-model/src/main/java/cn/yang37/entity/message/impl/SmsAliV3Message.java) | [MainTest.sendSmsAliV3Message](easy-push-test/src/test/java/MainTest.java) | - | [阿里云短信](https://help.aliyun.com/zh/sms/?spm=a2c4g.11186623.0.0.24735ee7SZGzIE) |
| 4    | 微信**测试号**   | [VxTestAccountMessage](easy-push-model/src/main/java/cn/yang37/entity/message/impl/VxTestAccountMessage.java) | [MainTest.sendVxTestAccountMessage](easy-push-test/src/test/java/MainTest.java) | [微信测试号.md](docs/渠道/微信/微信测试号.md) | [微信测试号](https://mp.weixin.qq.com/debug/cgi-bin/sandbox?t=sandbox/login) |
